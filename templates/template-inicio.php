...
<section class="section-one">
    <div class="slide-home" style="background-color: #000;">
        ...
        <!-- <img src="<php echo _URLTHEME; ?>/assets/img/playbutton.png" alt="" class="playvideo"> -->
...
<section class="section-three">
    <div class="content-three">
        ...
        <div class="filho">
        <img src="<?php echo _URLTHEME; ?>/assets/img/soap.png"><p class="texto">Higiene e Segurança, Apresentação dos Materiais, Ficha de anamnese <b> (2h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/sobrancelha.png"><p class="texto">Design de sobrancelhas <b> (6h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/line.png"><p class="texto">Threading de sobrancelhas <b> (6h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/eye.png"><p class="texto">Henna e Coloração de Sobrancelhas <b> (4h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/eye2.png"><p class="texto">Brow Lamination<b> (4h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/cilios.png"><p class="texto">Lifting de Pestanas<b> (6h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/ciliosposticos.png"><p class="texto">Técnicas de extensão de Pestanas<b> (8h)</b></p>
            </div>
            <div class="filho" >
        <img src="<?php echo _URLTHEME; ?>/assets/img/make.png"><p class="texto">Maquiagem de Olhos e Sobrancelhas <b> (4h)</b></p>
            </div>
